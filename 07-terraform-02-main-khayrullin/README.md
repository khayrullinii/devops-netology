...
## Ответ:
4. Ошибка была связана с тем, что для выбранной платформы необходимо 2 или 4 процессора. Исправил изменением resources { core = 2 }
5. preemptible - создает прерываемую ВМ, core_fraction - Гарантированная доля vCPU в процентах
