...
resource "local_file" "hosts_cfg" {
  ...
  content = templatefile("/home/ilnur/diplom/devops-netology/devops-diplom-2024-khayrullin/YC-terraform/hosts.tftpl",

    { kube_node =  yandex_compute_instance.kube_node}  )

  filename = "/home/ilnur/diplom/devops-netology/devops-diplom-2024-khayrullin/YC-terraform/hosts.ini"
}
...
resource "null_resource" "hosts_provision" {
  ...
  provisioner "local-exec" {                  
      command  = "export ANSIBLE_HOST_KEY_CHECKING=False; cd /home/ilnur/diplom/devops-netology/devops-diplom-2024-khayrullin/ansible-kubespray/kubespray; ansible-playbook -i /home/ilnur/diplom/devops-netology/devops-diplom-2024-khayrullin/YC-terraform/hosts.ini -b --diff cluster.yml"
      on_failure = continue
